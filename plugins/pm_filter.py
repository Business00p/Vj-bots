    ...
    if settings['button']:
        ...
        btn.insert(0, 
            [
                ...
                InlineKeyboardButton("🕵️ ᴇᴘɪsᴏᴅᴇs", callback_data=f"episodes#{key}"),
                InlineKeyboardButton("🌦️ sᴇᴀsᴏɴs",  callback_data=f"seasons#{key}")
            ]
        )
        btn.insert(0, [
            InlineKeyboardButton("♻️ 𝐒𝐞𝐧𝐝 𝐀𝐥𝐥", callback_data=f"sendfiles#{key}"),
    ...
    if settings["button"]:
        ...
        btn.insert(0, 
            [
                InlineKeyboardButton(f'✨ ǫᴜᴀʟɪᴛʏ', callback_data=f"qualities#{key}"),
                InlineKeyboardButton("🕵️ ᴇᴘɪsᴏᴅᴇs", callback_data=f"episodes#{key}"),
                InlineKeyboardButton("🌦️bsᴇᴀsᴏɴs",  callback_data=f"seasons#{key}")
            ]
        )
        btn.insert(0, [
            InlineKeyboardButton("♻️ 𝐒𝐞𝐧𝐝 𝐀𝐥𝐥", callback_data=f"sendfiles#{key}"),
      ...
      #      return
        ...
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('🔐 F-SUB', callback_data="shortlink_info"),
                InlineKeyboardButton('Pʀᴇᴍɪᴜᴍ 🎫', callback_data='subscription')
            ],[
                InlineKeyboardButton('</> Aᴅᴍɪɴ Cᴏᴍᴍᴀɴᴅꜱ', callback_data='admin'),
                InlineKeyboardButton('Aʙᴏᴜᴛ 💌', callback_data='about')
            ],[
                InlineKeyboardButton('🌿 Bᴏᴛ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url=CHNL_LNK)
            ]]
        else:
            buttons = [[
                InlineKeyboardButton('☆ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ☆', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐘𝐨𝐮𝐓𝐮𝐛𝐞', url="https://youtube.com/@techbro-kd8yk?si=s-5wy6LClNxGNmrm")
        ],[
